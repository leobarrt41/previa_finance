...
function toChartData(monthly, recurring) {
...
export function CashFlow() {
    ...
    return (_jsxs("div", { style: { maxWidth: 1020 }, children: [_jsxs("div", { style: { marginBottom: '1.5rem' }, children: [_jsx("h1", { style: { fontSize: '1.4rem', fontWeight: 800, color: '#e5e7eb', margin: 0 }, children: "\uD83D\uDCC8 Proje\u00E7\u00E3o de Fluxo de caixa" }), _jsx("p", { style: { color: '#6b7280', marginTop: '0.3rem', fontSize: '0.85rem' }, children: "Visualize seu saldo m\u00EAs a m\u00EAs. Compra no cart\u00E3o \u00E9 d\u00EDvida \u2014 o pagamento da fatura afecta o caixa." })] }), state.status === 'success' && state.data.cardInvoicesByMonth && (_jsxs("div", { style: {
                    ...
                    border: '1px solid #23263a',
                                        ...
                                        ].map(({ label, value, color }) => (_jsxs("div", { style: { background: '#141624', border: '1px solid #2a2f45', borderRadius: 10, padding: '0.75rem', textAlign: 'center' }, children: [_jsx("p", { style: { fontSize: '0.72rem', color: '#6b7280', marginBottom: 4 }, children: label }), _jsx("p", { style: { fontSize: '1rem', fontWeight: 800, color }, children: formatBRL(value) })] }, label))) }), _jsxs(Card, { children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', gap: '1rem', alignItems: 'baseline', marginBottom: '0.75rem', flexWrap: 'wrap' }, children: [_jsx(SectionTitle, { style: { margin: 0 }, children: "Recebido vs Sa\u00EDdas" }), _jsxs("div", { style: { fontSize: '0.78rem', color: '#9ca3af' }, children: [_jsxs("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6, marginRight: 12 }, children: [_jsx("span", { style: { width: 10, height: 10, borderRadius: 999, background: '#fbbf24' } }), "Parcelas"] }), _jsxs("span", { style: { display: 'inline-flex', alignItems: 'center', gap: 6 }, children: [_jsx("span", { style: { width: 10, height: 10, borderRadius: 999, background: '#7dd3fc' } }), "Sa\u00EDdas do extrato"] })] })] }), _jsx("div", { style: { fontSize: '0.76rem', color: '#6b7280', marginBottom: '0.75rem' }, children: "As barras amarelas mostram as parcelas que vencem em cada m\u00EAs. A barra laranja mostra apenas o saldo ainda aberto da fatura." }), _jsx(ResponsiveContainer, { width: "100%", height: 220, children: _jsxs(ComposedChart, { data: chartData, margin: { top: 4, right: 8, left: 0, bottom: 0 }, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#1e2130" }), _jsx(XAxis, { dataKey: "month", tick: { fill: '#6b7280', fontSize: 11 } }), _jsx(YAxis, { tick: { fill: '#6b7280', fontSize: 11 }, tickFormatter: (v) => `R$${(v / 1000).toFixed(0)}k` }), _jsx(Tooltip, { contentStyle: { background: '#1e2130', border: '1px solid #2a2f45', borderRadius: 8 }, labelStyle: { color: '#9ca3af' }, formatter: (v, name) => {
                                                                const labels = {
                                                                    recebido: 'Recebido',
