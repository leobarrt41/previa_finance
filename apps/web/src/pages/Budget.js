...
function renderCategoryTick(props) {
    const { x, y, payload } = props ?? {};
    const label = String(payload?.value ?? '');
    return (_jsxs("g", { transform: `translate(${Number(x) || 0},${(Number(y) || 0) + 4})`, children: [_jsx("title", { children: label }), _jsx("text", { x: 0, y: 0, dy: 0, textAnchor: "end", fill: "#cbd5e1", fontSize: 11, children: truncateLabel(label) })] }));
}
